...
//    Config::SetDefault ("ns3::TcpSocketBase::EcnMode",StringValue("ClassicEcn"));
  ...
  TypeId qdTid;
  NS_ABORT_MSG_UNLESS (TypeId::LookupByNameFailSafe (queueDisc, &qdTid), "TypeId " << queueDisc << " not found");
  ...
  myfile << "queue disc type" << queueDisc << "\n";
  myfile << "stream  " << stream << "\n";
  myfile << "transport_prot " << tcpTypeId << "\n";
